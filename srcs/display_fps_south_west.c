...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   display_south_west.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gpetit <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/02 12:40:20 by gpetit            #+#    #+#             */
/*   Updated: 2021/03/02 12:40:21 by gpetit           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		sw_ray(t_datas *map, t_ray *ray)
{
	...
	< map->lines && map->map[(int)(ray->trix.yc + 0.000001)][(int)(ray->trix.xc
	- 0.000001)] != '1')
	{
		ray->trix.xb--;
		ray->trix.xc = ray->trix.xb;
	...
	< map->lines && map->map[(int)(ray->triy.yc + 0.000001)][(int)(ray->triy.xc
	- 0.000001)] != '1')
	{
		ray->triy.yb++;
		ray->triy.yc = ray->triy.yb;
